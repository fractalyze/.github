...
| **chore**    | Minor housekeeping tasks that do not affect production logic. Examples: typo fixes, updating .gitignore, modifying .env.example, adjusting linter/config settings, or removing unused headers or redundant Bazel dependencies.      |
