...
This GitHub organization hosts our Python proving scheme framework ([Zorch]) and compiler stack ([ZKIR], [ZKX]), enabling automatic optimization for various target environments.
...
Just as [PyTorch] + [XLA] freed ML engineers from manual GPU tuning, [Zorch] + [ZKX]/[ZKIR] frees ZK researchers from manual proving system engineering.
...
**[ZKIR]**: ZKIR(ZK Intermediate Representation) is an intermediate language based on **[MLIR]**(Multi-Level Intermediate Representation dedicated to cryptographic optimization for ZK proofs.
...
[ZKIR]: https://github.com/fractalyze/zkir
